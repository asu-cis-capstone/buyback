        ...
        <div class = "network">
            ...
            <div class="btn-group" data-toggle="buttons">
                ...
                <label class="btn btn-primary active">
                    <input type="radio" name="condtion" id="good">GOOD
                </label>
                <label class="btn btn-primary">
                    <input type="radio" name="condition" id="cracked">CRACKED
                </label>
                <label class="btn btn-primary">
                    <input type="radio" name="condition" id="damaged">DAMAGED
                </label>
                <label class="btn btn-primary">
           ...
           <span class="whybuybackpoint1">
               Prices Guaranteed for 30 days
           </span>

           <span class="whybuybackpoint2">
               Same-day Payment
           </span>

           <span class="whybuybackpoint3">
