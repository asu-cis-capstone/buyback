...
<html lang="en">
  ...
  <body>
	<?php
		...
		{
			$errormessage = "This combination of Carrier and Size is invalid. Please make a different selection.";
					...
					<form action="../options/priceProcess.php" method="post">
						<div class="btn-group" data-toggle="buttons">
							<label class="btn btn-primary">
							 ...
							 <label class="btn btn-primary">
								<input type="radio" name="carrier" id="tmobile" value="TMOBILE"><img src="../images/TMOBILE.png" alt="TMOBILE" />
							 </label>
							 <label class="btn btn-primary">
						...
						<button id="checkoutButton" class="btn btn-default" type="submit" value="checkout">Next</button>
					</form>
				</div>						
			</p>		
		</div>
